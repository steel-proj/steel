...
void name_resolver::visit(compilation_unit& unit) {
...
void name_resolver::visit(function_declaration& func) {
	if (func.body) {
...
void name_resolver::visit(variable_declaration& var) {
...
void name_resolver::visit(type_declaration& decl) {
	sym_table->push_scope();
	current_type = decl;
...
void name_resolver::visit(module_declaration& module) {
...
void name_resolver::visit(binary_expression& expr) {
	expr.left->accept(*this);
	expr.right->accept(*this);
}
void name_resolver::visit(identifier_expression& expr) {
	// resolve identifier
...
void name_resolver::visit(member_expression& expr) {
...
void name_resolver::visit(this_expression& expr) {
...
void name_resolver::visit(function_call& func_call) {
	// resolve args
...
void name_resolver::visit(code_block& block) {
	if (!block.is_body) {
		sym_table->push_scope();
	}
...
void name_resolver::visit(if_statement& if_stmt) {
...
void name_resolver::visit(for_loop& for_loop) {
	sym_table->push_scope();
...
void name_resolver::visit(while_loop& while_loop) {
